...
//        //1加载json文件到内存中
////        val fileStr = KtStringUtil.getStrInFile("/home/ccg/ck.json")
//        val fileStr = KtStringUtil.getStrInFile("E:\\ck.json")
//        //2把json转换成list
...
////        KtStringUtil.saveAsFileWriter("/home/ccg/ck1.json", GsonBuilder().create().toJson(list))
//        KtStringUtil.saveAsFileWriter("E:\\ck1.json", GsonBuilder().create().toJson(list))
...
//    fun cleaningDataTwo() {
//        //1加载json文件到内存中
//        val fileStr = KtStringUtil.getStrInFile("E:\\ck1.json")
//        val fileStrTwo = KtStringUtil.getStrInFile("E:\\ckText.json")
////        //2把json转换成list
...
//        KtStringUtil.saveAsFileWriter("E:\\ckok.json", GsonBuilder().create().toJson(listDatasOne))
//    }
//    /**
//     * B2把最终结果分解成几份
//     */
...
//        //1加载json文件到内存中
//        val fileStr = KtStringUtil.getStrInFile("E:\\ckok.json")
...
//            videoUrl.add("https://siyou.nos-eastchina1.126.net/21/ck/$i.json")
//        }
