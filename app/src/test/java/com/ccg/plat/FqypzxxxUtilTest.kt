...
//    fun cleaningDataTwo() {
//        //1加载json文件到内存中
//        val fileStr = KtStringUtil.getStrInFile("/home/ccg/fqypzxxx1.json")
////        val fileStr = KtStringUtil.getStrInFile("E:\\buzz1.json")
//        val fileStrTwo = KtStringUtil.getStrInFile("/home/ccg/fqypzxxxText.json")
...
//        KtStringUtil.saveAsFileWriter("/home/ccg/fqypzxxxok.json", GsonBuilder().create().toJson(listDatasOne))
////        KtStringUtil.saveAsFileWriter("E:\\fqypzxxxok.json", GsonBuilder().create().toJson(listDatasOne))
//    }
//
//
//
...
//        //1加载json文件到内存中
//        val fileStr = KtStringUtil.getStrInFile("/home/ccg/fqypzxxxok.json")
////        val fileStr = KtStringUtil.getStrInFile("E:\\fqypzxxxok.json")
...
//            videoUrl.add("https://siyou.nos-eastchina1.126.net/21/fqypzxxx/$i.json")
//        }
