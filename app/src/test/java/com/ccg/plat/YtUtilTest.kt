...
//        //1加载json文件到内存中
//        val fileStr = KtStringUtil.getStrInFile("/home/ccg/yt.json")
////        val fileStr = KtStringUtil.getStrInFile("E:\\yt.json")
//        //2把json转换成list
...
//        KtStringUtil.saveAsFileWriter("/home/ccg/yt1.json", GsonBuilder().create().toJson(list))
////        KtStringUtil.saveAsFileWriter("E:\\yt1.json", GsonBuilder().create().toJson(list))
