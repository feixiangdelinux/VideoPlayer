...
//        val fileStr = KtStringUtil.getStrInFile("E:\\fe.json")
//        //2把json转换成list
//        val listDatas = GsonBuilder().create().fromJson<List<VideoBean>>(fileStr, object : TypeToken<List<VideoBean>>() {}.type)
...
//        KtStringUtil.saveAsFileWriter("E:\\fe1.json", GsonBuilder().create().toJson(list))
...
//        val fileStr = KtStringUtil.getStrInFile("E:\\fe1.json")
////        val fileStrTwo = KtStringUtil.getStrInFile("/home/ccg/buzzText.json")
//        val fileStrTwo = KtStringUtil.getStrInFile("E:\\feText.json")
////        //2把json转换成list
...
//        KtStringUtil.saveAsFileWriter("E:\\feok.json", GsonBuilder().create().toJson(listDatasOne))
//    }
//
//    /**
//     * B2把最终结果分解成几份
...
//        val fileStr = KtStringUtil.getStrInFile("E:\\feok.json")
//        val listDatasOne = GsonBuilder().create().fromJson<ArrayList<VideoBean>>(fileStr, object : TypeToken<ArrayList<VideoBean>>() {}.type)
...
//            videoUrl.add("https://siyou.nos-eastchina1.126.net/21/fe/$i.json")
//        }
