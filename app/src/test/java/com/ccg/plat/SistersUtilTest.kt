...
//        val fileStr = KtStringUtil.getStrInFile("E:\\sisters.json")
//        //2把json转换成list
...
//        KtStringUtil.saveAsFileWriter("E:\\sisters1.json", GsonBuilder().create().toJson(list))
...
//    fun cleaningDataTwo() {
//        //1加载json文件到内存中
////        val fileStr = KtStringUtil.getStrInFile("/home/ccg/sisters1.json")
//        val fileStr = KtStringUtil.getStrInFile("E:\\sisters1.json")
////        val fileStrTwo = KtStringUtil.getStrInFile("/home/ccg/sistertext.json")
//        val fileStrTwo = KtStringUtil.getStrInFile("E:\\sistertext.json")
////        //2把json转换成list
...
////        KtStringUtil.saveAsFileWriter("/home/ccg/sistersok.json", GsonBuilder().create().toJson(listDatasOne))
//        KtStringUtil.saveAsFileWriter("E:\\sistersok.json", GsonBuilder().create().toJson(listDatasOne))
//    }
//
//    /**
//     * B2把最终结果分解成几份
...
//        //1加载json文件到内存中
////        val fileStr = KtStringUtil.getStrInFile("/home/ccg/sistersok.json")
//        val fileStr = KtStringUtil.getStrInFile("E:\\sistersok.json")
...
//            videoUrl.add("https://siyou.nos-eastchina1.126.net/21/sisters/$i.json")
//        }
