 ...
 * 主要功能 :
 * 维护人员 : C4_雍和
 * date : 20-9-15 上午10:01
 */
class TjfzjdUtilTest {
//    /**
//     * A完整数据并去重复/home/ccg
//     */
//    @Test
...
//        //1加载json文件到内存中
//        val fileStr = KtStringUtil.getStrInFile("/home/ccg/tjfzjd.json")
////        val fileStr = KtStringUtil.getStrInFile("E:\\tjfzjd.json")
//        //2把json转换成list
...
//        KtStringUtil.saveAsFileWriter("/home/ccg/tjfzjd1.json", GsonBuilder().create().toJson(list))
////        KtStringUtil.saveAsFileWriter("E:\\tjfzjd1.json", GsonBuilder().create().toJson(list))
...
//    fun cleaningDataTwo() {
//        //1加载json文件到内存中
//        val fileStr = KtStringUtil.getStrInFile("/home/ccg/tjfzjd1.json")
////        val fileStr = KtStringUtil.getStrInFile("E:\\tjfzjd1.json")
//        val fileStrTwo = KtStringUtil.getStrInFile("/home/ccg/tjfzjdText.json")
////        val fileStrTwo = KtStringUtil.getStrInFile("E:\\tjfzjdText.json")
////        //2把json转换成list
...
//        KtStringUtil.saveAsFileWriter("/home/ccg/tjfzjdok.json", GsonBuilder().create().toJson(listDatasOne))
////        KtStringUtil.saveAsFileWriter("E:\\tjfzjdok.json", GsonBuilder().create().toJson(listDatasOne))
//    }
//
//    /**
//     * B2把最终结果分解成几份
...
//        //1加载json文件到内存中
//        val fileStr = KtStringUtil.getStrInFile("/home/ccg/tjfzjdok.json")
////        val fileStr = KtStringUtil.getStrInFile("E:\\tjfzjdok.json")
...
//            videoUrl.add("https://siyou.nos-eastchina1.126.net/21/tjfzjd/$i.json")
//        }
